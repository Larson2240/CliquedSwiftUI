...
class AppDelegate: UIResponder, UIApplicationDelegate,UNUserNotificationCenterDelegate {
    ...
    func setRootViewController() {
        if userDefaults.bool(forKey: UserDefaultKey.isLoggedIn) && userDefaults.bool(forKey: UserDefaultKey.isRemeberMe) {
            setLanguage()
    ...
    func setRegisterOptionRootViewController() {
        setLanguage()
        let registeroptvc = RegisterOptionVC.loadFromNib()
        APP_DELEGATE.window?.rootViewController = UINavigationController(rootViewController: registeroptvc)
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        print("=======================App Terminate=====================================")
              //Managed socket event if user kill app in-between call
       
        if userDefaults.bool(forKey: UserDefaultKey.isLoggedIn) && userDefaults.bool(forKey: UserDefaultKey.isRemeberMe) == false {
            clearUserDefault()
        }
...
extension AppDelegate : PKPushRegistryDelegate {
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
        ...
        userDefaults.setValue(device_token, forKey: kDeviceToken)            
